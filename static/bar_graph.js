...
function optionChanged() {
  ...
  const urlcatOf = `/static/office.csv`;
  const urlcatT = `/static/tech.csv`;
  const urlcat = `/static/furn.csv`;

  d3.csv(urlcat).then(function (data_cat) {
  d3.csv(urlcatOf).then(function (data_catOf) {   
  d3.csv(urlcatT).then(function (data_catT) {
    //************************************************************************
